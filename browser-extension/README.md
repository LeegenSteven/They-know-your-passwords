...
Check [keepassxc-protocol](they-know-your-passwords-protocol.md) for the details about the messaging protocol used between the browser extension and KeePassXC.
