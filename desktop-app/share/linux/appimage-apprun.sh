...
if [ "$1" == "cli" ] || [ "$(basename "$ARGV0")" == "keepassxc-cli" ] || [ "$(basename "$ARGV0")" == "keepassxc-cli.AppImage" ]; then
    ...
    # --- Icon file setup ---
    icon_source="$APPDIR/usr/share/icons/hicolor/256x256/apps/they-know-your-passwords.png"
    icon_target="${XDG_DATA_HOME:-$HOME/.local/share}/icons/hicolor/256x256/apps/they-know-your-passwords.png"
