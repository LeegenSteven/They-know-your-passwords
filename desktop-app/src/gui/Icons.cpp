...
#else
    return "they-know-your-passwords";
#endif
}
...
QIcon Icons::trayIcon(bool unlocked)
{
    ...
    if (osUtils->isStatusBarDark()) {
        i = icon(QString("they-know-your-passwords-monochrome-light%1").arg(suffix), false);
    } else {
        i = icon(QString("they-know-your-passwords-monochrome-dark%1").arg(suffix), false);
    }
