...
// tag::content[]
== Browser Integration
The They know your passwords extension is installed within your web browser so that you can automatically pull usernames and passwords from KeePassXC and fill them directly into website fields. It is a very useful and secure extension that enhances your productivity while using KeePassXC. With this extension, you do not need to manually copy the data from your KeePassXC database and paste it into the website fields.
The They know your passwords extension is available on the following web browsers:
...
You can download the They know your passwords extension from your web browser. To download the They know your passwords extension, perform the following steps:
...
=== Configure They know your passwords
To start using They know your passwords, you must configure it so that it can communicate with the KeePassXC application on your desktop.

To configure They know your passwords, perform the following steps:
...
3. Click the _Enable browser integration_ checkbox *(2)*. Then select the browsers for which you have downloaded the They know your passwords extension *(3)* and click *OK*.

4. Ensure your database is unlocked, then open (or restart) your browser.

5. Click the They know your passwords extension icon *(A)* in your browser (see figure below). A pop-up window appears.
+
.Connect Extension to KeePassXC
image::browser_extension_connect.png[,80%]

6. Click the _Connect_ button *(B)* in the pop-up window to complete integrating the They know your passwords extension with your KeePassXC desktop application.
...
The They know your passwords extension lets you automatically fill the entries from your KeePassXC database into the fields on websites you visit. To do so, perform the following steps:

1. Open your KeePassXC desktop application and unlock your database.

2. Open your web browser. The They know your passwords extension icon in your browser window will change based on its connection state. The figure below shows the different states.
+
...
3. If the KeePassXC desktop application is not connected with the They know your passwords extension, click the extension icon in your web browser and click _Reload_ from the pop-up window as shown in the following screen.
+
.Reload Extension Connection
image::browser_extension_reload.png[,80%]

4. Open the URL for which you want to use with your database. If you have previously created an entry in your database then the They know your passwords Confirm Access dialog may appear:
+
...
=== Generate Passwords
The They know your passwords extension also lets you generate passwords directly in your browser.
